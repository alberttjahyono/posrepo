...
class InsertValidator implements InputFilterAwareInterface {
			...
			array(
				...
				'validators' => array( 
					array(
						...
						'options' => array(
							'messages' => array('isEmpty' => 'Harga tidak boleh kosong !')
						),  
					),
					array(
						'name' => 'Digits', 
						'break_chain_on_failure' => true,
						'options' => array(
							'messages' => array('notDigits' => 'Harga harus bertipe integer !')
						),  
					),	
				), 
			)));
